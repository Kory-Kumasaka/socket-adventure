...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        :return: str
        """
        return ["You are in the Garage, it has a 4 post lift", "You are in the Woodshop, watch your fingers!!!",
                "You are in the Man Cave, grab a beer and take a load off",
                "You found the Office time to order beer and car parts"][room_number]
    ...
    def say(self, argument):
        ...
        self.push_output('You Say:  + "{}"'.format(argument))
